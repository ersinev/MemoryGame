      ...
      <Row>
        ...
        <Col className="d-flex justify-content-center align-items-center">
          <div style={{ marginBottom: "20px" }}>
            ...
            <p style={{ color: "white", fontSize: "24px", border: "5px solid green", backgroundColor: "rgba(0, 128, 0, 0.5)", padding: "10px", borderRadius: "10px" }}>Total Elapsed Time: {totalElapsedTime}</p>
